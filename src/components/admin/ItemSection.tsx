...
const ItemSection: React.FC<Props> = ({ categories, items, setPopup }) => {
  ...
  return (
    <div className="bg-white p-5 rounded-2xl border-4 border-[#FCD451] relative">
      ...
      <div className="flex flex-col gap-3 mb-5">
        ...
        <div className="flex flex-col">
          <input
            className={`w-full p-2 border rounded-lg focus:ring-2 focus:ring-[#FCD451]
        ...
        <input
          className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FCD451]"
        ...
        <button
          onClick={addItem}
          className="bg-[#FCD451] text-black font-semibold px-5 py-2 rounded-lg hover:bg-[#FCD451]/80 transition shadow-md shadow-[#FCD451]/30"
        >
          إضافة الصنف
        </button>
        ...
        {showToast && (
          <div className="absolute top-0 right-1/2 transform translate-x-1/2 -translate-y-full
            bg-linear-to-r from-[#FCD451] to-[#fce7b5] text-black px-4 py-2 rounded-2xl font-bold shadow-lg shadow-black/30 transition animate-fade-in-out z-50">
      ...
      {/* ================== البحث ================== */}
      <input
        className="w-full p-2 mb-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FCD451]"
          ...
          return (
            <div key={catId} className="rounded-lg border border-gray-200 shadow-sm">
              ...
              >
                ...
                <span>{cat.name}
                  <span className="bg-[#FCD451] text-black text-sm px-2 py-0.5 mr-4 rounded-full">
                    {catItems.length}
                  </span>
                </span>
